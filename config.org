...
(package! ewm
  :recipe (:host codeberg
           ...
           :branch "Flake"
           :files ("lisp/*.el"))
  :pin "9617ae30bee6871c6abc4965062bc5bcf7342065")
(package! ewm-consult :recipe (:host github :repo "ArthurHeymans/ewm-consult")
  :pin "f42cf45ac6bfb68d7b5a698d7ec0a5050ee39a92")
#+end_src
#+begin_src elisp :tangle config.el
(after! ewm
  (setq ewm-xkb-options "caps:ctrl_modifier")
...
(after! gptel
  (setq!
         ...
         gptel-magit-model 'claude-sonnet-4-5-20250929
