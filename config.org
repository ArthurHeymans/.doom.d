...
#+begin_src elisp :tangle packages.el
(package! org-ql :recipe (:host github :repo "anpandey/org-ql" :branch "format-element-effort") :pin "ae202356b13340bc488a2b22e5cf6a3478d80246")
#+end_src
** Agenda
*** Agenda format
#+begin_src elisp :tangle config.el
...
(package! aidermacs :recipe (:host github :repo "MatthewZMD/aidermacs"
                             :files ("aidermacs-backend-comint.el" "aidermacs-backend-vterm.el"
                                     "aidermacs-backends.el" "aidermacs-doom.el" "aidermacs-models.el"
                                     "aidermacs-utils.el"  "aidermacs.el"))
  :pin "4c7265f33f044dffda3bbc77b22e6f35e0e6752e")
#+end_src
...
(after! aidermacs
  ...
  (setq aidermacs-args '("--model" "openrouter/anthropic/claude-3.7-sonnet" "--cache-prompts" "--watch-files"))
  (aidermacs-doom-enable)
     )
#+end_src
** Elysium
#+begin_src elisp :tangle packages.el
