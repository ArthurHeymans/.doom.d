...
(use-package! aider
  :config
  ;; Use Claude Sonnet model with no auto-accept for architect commands
  ...
  ;; Optional: Use personal config file instead
  ;; (setq aider-args `("--config" ,(expand-file-name "~/.aider.conf.yml")))
  
  ;; Set up key bindings for the transient menu
  (map! :leader
        :desc "Aider transient menu" "A" #'aider-transient-menu))
#+end_src
