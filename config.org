...
(after! gptel
  ...
  (gptel-make-anthropic "9e Claude"          ;Any name you want
    :stream t                             ;Streaming responses
    :key (get-auth-info :user "9eapikey" :host "api.anthropic.com"))
...
(use-package! slack
  ...
  ;; (slack-register-team
  ;;  :name "your-team-name"
  ;;  :token (get-auth-info :user "token" :host "slack-your-team")
  ;;  :cookie (get-auth-info :user "cookie" :host "slack-your-team")
