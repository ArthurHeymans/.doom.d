...
(use-package! slack
  ...
  ;; Example configuration (uncomment and fill in your details):
  ;; (slack-register-team
  ;;  :name "your-team-name"
  ;;  :token (auth-source-pick-first-password :host "slack-your-team" :user "token")
  ;;  :cookie (auth-source-pick-first-password :host "slack-your-team" :user "cookie")
