...
#+begin_src elisp :tangle packages.el
(package! gptel-agent)
(package! consult :pin "c2caf93d597ea57db86c0cbf7ff50114a57d74f6") ; TODO: Remove consult pinning once doom has it right
(package! gptel :pin "9d6313ce7c6eb71bfb24a8d1edcd60fe4534eea3")
#+end_src
#+begin_src elisp :tangle config.el
(after! gptel-agent
  (gptel-agent-update))
...
#+begin_src elisp :tangle packages.el
(package! acp :recipe (:host github :repo "xenodium/acp.el") :pin "3c6a39c09684145b82721b506b80fa857664258a")
(package! agent-shell :recipe (:host github :repo "xenodium/agent-shell") :pin "086d316836687f3c3e59201e8a2e213fe6951550")
#+end_src
